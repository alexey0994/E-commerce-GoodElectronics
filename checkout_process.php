...
if (isset($_SESSION["uid"])) {
	...
	(`order_id`,`user_id`,`f_name`, `email`,`country`, 
	`address`, `zip`, `cardname`,`cardnumber`,`expdate`,`prod_count`,`total_amt`,`cvv`) 
	VALUES ($order_id, '$user_id','$f_name','$email', 
    '$country', '$address', '$zip','$cardname','$cardnumberstr','$expdate','$total_count','$prod_total','$cvv')";
