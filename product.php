...
?>
	...
	// Раньше у нас был setInterval здесь....
    ...
    global.onload = function () {        
		noBackPlease();
		// отключает возврат на странице, кроме полей ввода и текстовой области.
		document.body.onkeydown = function (e) {
            var elm = e.target.nodeName.toLowerCase();
            if (e.which === 8 && (elm !== 'input' && elm  !== 'textarea')) {
                e.preventDefault();
            }
            //остановка события, поднимающего дерево DOM ..
            e.stopPropagation();
        };		
    };
})(window);
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">3 Отзыва</a>
							</div>
							<div>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">15 Апр 2020, 12:35</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Николай</h5>
															<p class="date">18 Апр 2020, 18:17</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Доставка оказалась очень быстрой</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Виктор</h5>
															<p class="date">20 Апр 2020, 2:30</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Полностью доволен продуктом</p>
														</div>
													</li>
												</ul>
		...
		<div class="section main main-raised">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN $product_id AND $product_id+15";
