                ...
                <div class="table-responsive ps">
                  <table class="table tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Картинка</th><th>Имя</th><th>Цена</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Добавить новый</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <a class=' btn btn-success' href='productlist.php?product_id=$product_id&action=delete'>Удалить</a>
                        </td></tr>";
                        }
