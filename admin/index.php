...
?>
      ...
      <div class="content">
		...
		<a>
            <?php  //сообщение об успехе
            if(isset($_POST['success'])) {
            $success = $_POST["success"];
            echo "<h1 style='color:#0C0'>Ваш продукт успешно добавлен &nbsp;&nbsp;  <span class='glyphicon glyphicon-ok'></h1></span>";
            }
            ?></a>
                </div>
                <div class="col-md-14">
                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Имя</th><th>Фамилия</th><th>Email</th><th>Пароль</th><th>Телефон</th><th>Страна</th><th>Адрес</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Категории</th><th>Кол-во</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Бренды</th><th>Кол-во</th>
                    </tr></thead>
                    <tbody>
                      <?php 
