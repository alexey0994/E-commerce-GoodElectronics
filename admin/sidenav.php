...
<body class="dark-edition">
  <div class="wrapper ">
    <div class="sidebar" data-color="azure" data-background-color="black" data-image="./assets/img/sidebar-2.jpg">
      <!--
      Совет 1: Можно изменить цвет боковой панели, используя: data-color="purple | azure | green | orange | danger"

      Совет 2: Вы также можете добавить изображение с помощью тега data-image
  -->
      <div class="logo">
