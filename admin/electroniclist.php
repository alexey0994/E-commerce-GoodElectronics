              ...
              <div class="card-header card-header-primary">
                ...
                <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                      <label class="btn btn-sm btn-primary btn-simple active" id="0">
                        <input type="radio" name="options" autocomplete="off" checked=""> электроника
                      </label>
                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Картинка</th><th>Название</th><th>Цена</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Добавить новую</a></th></tr></thead>
                    <tbody>
                      <?php 
