...
/* Адаптивный макет - когда ширина экрана составляет менее 800 пикселей, две колонки укладываются друг на друга, а не рядом друг с другом(также можно изменить направление - заставить столбец «корзины» идти сверху) */
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="country"><i class="fa fa-address-card-o"></i> Страна</label>
						<input type="text" id="country" name="country" class="form-control" value="'.$row["address1"].'" required>
						<label for="address"><i class="fa fa-institution"></i> Адрес</label>
						<input type="text" id="address" name="address" class="form-control" value="'.$row["address2"].'"  required>
					...
					<div class="col-50">
						...
						<label for="cname">Имя владельца карты</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required>Адрес доставки совпадает с адресом выставления счета
					</label>';
					$i=1;
					$total=0;
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Продолжить оформление заказа" class="checkout-btn">
				</form>
				</div>
			</div>
			';
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Подписывайтесь на наши <strong>рассылки</strong></p>
							<form >
